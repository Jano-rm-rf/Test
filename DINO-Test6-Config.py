...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            'mmpre-weights/efficientnetv2-s_3rdparty_in21k_20221220-c0572b56.pth',
            prefix='backbone.',
            type='Pretrained'),
        out_indices=(
            1,
...
model_ckpt = 'dino-4scale_r50_8xb2-12e_coco_20221202_182705-55b2bba2.pth'
num_classes = 1
num_levels = 5
optim_wrapper = dict(
    accumulative_counts=2,
    clip_grad=dict(max_norm=0.1, norm_type=2),
    optimizer=dict(lr=1.25e-05, type='AdamW', weight_decay=0.0001),
...
pretrained = 'mmpre-weights/efficientnetv2-s_3rdparty_in21k_20221220-c0572b56.pth'
resume = True
resume_from = 'work_dirs/DINO_R50/best_coco_bbox_mAP_epoch_12.pth'
